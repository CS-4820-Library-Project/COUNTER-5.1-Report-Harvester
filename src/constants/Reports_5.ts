...
export const PR: Report = {
  ...
  attributes: {
    Exclude_Monthly_Details: false,
    Attributes_To_Show: ["Platform", "Metric_Type", "Reporting_Period_Total"],
  },
};
...
export const TR: Report = {
  ...
  filters: {
    ...
    Section_Type: ["Article", "Book", "Chapter", "Other", "Section"],
    Data_Type: [
      "Book",
      "Conference",
      "Journal",
...
export const reports_5: Reports = {
  label: "COUNTER 5 Reports",
  main: [PR, DR, TR, IR],
